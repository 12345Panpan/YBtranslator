...
class Mywindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def translateBaidu(self, content, toLang, fromLang):
        ...
        myurl = '/api/trans/vip/translate' + '?appid=' + appid + '&q=' + urllib.parse.quote(
            q) + '&from=' + fromLang + '&to=' + str(toLang) + '&salt=' + str(salt) + '&sign=' + sign
        try:
    ...
    def save_srt(self, title, srt_name, language, lang_org):
        srt_after_name = title + '_' + str(language) + '.srt'
        # self.trans = Translator(service_urls=['translate.google.cn'])
                ...
                for line in file_obj:
                    ...
                    if self.line_index % interval == 2:
                        ...
                        if line == '':
                            ...
                            line_after = str(self.translateBaidu(line, toLang=language, fromLang=lang_org)) + '\n'
    ...
    def DataSyn(self):
        ...
        for i in range(lang_num):
            ...
            if lang_select_after[i] in lang_dict:
                ...
                lang_select_after[i] = lang_select_after[i][0:2]
